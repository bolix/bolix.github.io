...
// var open=["X","9:00am","9:00am","9:00am","9:00am","9:00am","1:30pm"];
	...
	var open=["5:00pm","5:00pm","5:00pm","5:00pm","5:00pm","5:00pm","5:00pm"]; // Edit this line 

// Enter the time your library closes, starting with Sunday. If your library is 
// closed, enter "X" for the time.

	var close=["12:00pm","12:00pm","12:00pm","12:00pm","12:00pm","2:00pm","2:00pm"]; // Edit this line
...
// -------------------------------------------------------------------
	...
	{ // Build the hours string
		if(openTime == "X") {
			...
			var libhours = "<strong>Horario de hoy   :</strong> " + openTime + " &#8211; " + closeTime;
			document.write(libhours);
		}
	}
